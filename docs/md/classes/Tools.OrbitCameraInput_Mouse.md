[pc-ex](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/README.md) / [Tools](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/modules/Tools.md) / OrbitCameraInput\_Mouse

# Class: OrbitCameraInput\_Mouse

[Tools](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/modules/Tools.md).OrbitCameraInput_Mouse
...
- [constructor](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#constructor)

### Properties

- [app](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#app)
- [toolOptions](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#tooloptions)
- [toolOptionsDefault](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#tooloptionsdefault)

### Accessors

- [enabled](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#enabled)

### Methods

- [fire](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#fire)
- [hasEvent](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#hasevent)
- [off](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#off)
- [on](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#on)
- [onDisable](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#ondisable)
- [onEnable](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#onenable)
- [once](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#once)
- [setOptions](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#setoptions)
- [updateOptions](https://github.com/TheFBplus/pc-ex/blob/master/docs/md/classes/Tools.OrbitCameraInput_Mouse.md#updateoptions)
